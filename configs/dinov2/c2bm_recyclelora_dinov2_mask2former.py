# RecycleLoRA (DINOv2-L + Mask2Former), real-to-real: Cityscapes -> {BDD, Mapillary}
_base_ = [
    "../_base_/datasets/dg_c2bm_512x512.py",
    "../_base_/default_runtime.py",
    "../_base_/models/recyclelora_dinov2_mask2former.py",
]

# Sub-adapter rank 2: r_max = 32 (main) + 2 (sub).
model = dict(backbone=dict(r_max=34))
