# RecycleLoRA (DINOv2-L + Mask2Former), synthetic three-source:
# GTAV (12,403 random subset) + Synthia + UrbanSyn -> {Cityscapes, BDD, Mapillary}
_base_ = [
    "../_base_/datasets/dg_gsu2cbm_512x512.py",
